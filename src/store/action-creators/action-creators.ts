...
export const setRelevChars = createAction<Person[]>('SET_RELEV_CHARS')
...
export const setPeople = createAction<Person[]>('SET_PEOPLE');
...
export const setPersonItem = createAction<Person>('SET_PERSON_ITEM');
...
export const addItemsToDisplayPeople = createAction('ADD_ITEMS_PEOPLE');
...
export const setNumberOfItemsDisplayPeople = createAction<number>('SET_NUMBER_PEOPLE');
...
export const discardPeopleItemsAmmount = createAction('DISCARD_PEOPLE_AMMOUNT');
