...
export var createMovieItemYupValScheme = yup.object({
    title: yup
        .string()
...
export var loginPageYupValScheme = yup.object({
    email: yup
        .string()
...
export var accCreateYupValScheme = yup.object({
    email: yup
        .string()
        .email('Enter a valid email')
        .required('Email is required'),
...
export var movieEditYupValScheme = yup.object({
    title: yup
        .string()
        .required('Title is required'),
    producer: yup
...
export var NavbarSearchYupValScheme = yup.object({
    title: yup
        .string()
        .required('Title is required')
});
